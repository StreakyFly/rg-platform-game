...
export class Renderer extends BaseRenderer {
    ...
    render(scene, camera, light) {
        ...
        gl.uniform3fv(uniforms.uLight.color, vec3.scale(vec3.create(), lightComponent.color, 1 / 255));
        gl.uniform3fv(uniforms.uLight.position, mat4.getTranslation(vec3.create(), getGlobalModelMatrix(light)));
