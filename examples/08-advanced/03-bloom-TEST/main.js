...
const black = new ImageData(new Uint8ClampedArray([0, 0, 0, 0]), 1, 1);
// const orange = new ImageData(new Uint8ClampedArray([255, 119, 0, 255]), 1, 1);
// const orange = new ImageData(new Uint8ClampedArray([255, 60, 0, 255]), 1, 1);
const orange = new ImageData(new Uint8ClampedArray([100000, 100000, 100000, 255]), 1, 1);
...
gui.add(renderer, 'bloomThreshold', 0, 100);
